...
local v15 = v14:CreateWindow({
    Title = "HoangAnh Hub [Premium ]",-- thay tên bạn muốn đặt
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=15298567397";
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://108610659764941") then --thay id ảnh vào
                    return v729;
                end
            end
        end
